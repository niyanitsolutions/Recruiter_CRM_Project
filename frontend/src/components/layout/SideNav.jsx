    ...
    <aside className={clsx(
      ...
      mobileOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'
        ...
        boxShadow: themeMode === 'system'
          ...
          : isDark
          ? 'inset -8px 0 32px rgba(22,124,251,0.18), 4px 0 24px rgba(0,0,0,0.40)'
          : '2px 0 12px rgba(22,124,251,0.06)',
      }}>
      {/* Logo */}
      <div
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <div className="flex items-center gap-3">
              <EmployeeAvatar
                ...
                size={36}
                style={{ boxShadow: '0 0 10px rgba(22,124,251,0.3)' }}
              />
      ...
      <button
        ...
        style={{ background: 'linear-gradient(135deg, #167CFB, #0267F9)', border: '1px solid rgba(22,124,251,0.4)', boxShadow: '0 0 10px rgba(22,124,251,0.4)' }}
      >
