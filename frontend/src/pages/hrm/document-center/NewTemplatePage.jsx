...
const CARDS = [
  ...
  },
  {
    ...
    title: 'Quick Builder',
    subtitle: 'Simple document creation in minutes',
    description: 'Use a clean, Word-like editor to build professional HR documents quickly with pre-configured sections and dynamic fields.',
    features: [
      { icon: AlignLeft, text: 'Rich text editor (Bold, Italic, Alignment…)' },
      { icon: Table2,    text: 'Insert tables, lists & dividers' },
      { icon: Image,     text: 'Logo, images & signature blocks' },
      { icon: Palette,   text: 'Header, footer & watermark config' },
      { icon: Type,      text: 'One-click HR field insertion' },
    ],
