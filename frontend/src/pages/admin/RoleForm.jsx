...
const PERMISSION_SECTIONS = [
  ...
  { section: 'HR Management', modules: [
    ...
    { label: 'Candidates',    perms: ['candidates:view','candidates:create','candidates:edit','candidates:delete','candidates:assign'] },
    { label: 'Onboards',      perms: ['onboards:view','onboards:create','onboards:edit'] },
    { label: 'HRM Dashboard', perms: ['hrm:dashboard:view'] },
    { label: 'Employees',     perms: ['hrm:employees:view','hrm:employees:manage'] },
    { label: 'Attendance',    perms: ['hrm:attendance:self','hrm:attendance:team','hrm:attendance:manage'] },
    { label: 'Leaves',        perms: ['hrm:leave:apply','hrm:leave:team_approve','hrm:leave:manage'] },
    { label: 'Payroll',       perms: ['hrm:payroll:view_self','hrm:payroll:manage'] },
    { label: 'Performance',   perms: ['hrm:performance:self','hrm:performance:team','hrm:performance:manage'] },
    { label: 'Announcements', perms: ['hrm:announcements:view','hrm:announcements:manage'] },
    { label: 'Internal Hiring', perms: ['hrm:hiring:view','hrm:hiring:manage'] },
    { label: 'Documents',     perms: ['hrm:documents:manage'] },
    { label: 'Assets',        perms: ['hrm:assets:view','hrm:assets:manage'] },
    { label: 'Exit Management', perms: ['hrm:exit:view','hrm:exit:manage'] },
  ]},
