...
import {
  Users, UsersRound, Building2, Layers, Award, GitBranch,
  Mail, Bell,
  Lock, ScrollText, Target,
    ...
    <div className="p-6 max-w-5xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-surface-500 mt-1 text-sm">
          Configure your organisation — users, communication, system security and performance targets.
        </p>
      </div>
