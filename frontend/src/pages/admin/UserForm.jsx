...
const MODULE_PERMS = {
  ...
  users_hr:                ['users:view','users:create','users:edit'],
  roles:                   ['roles:view','roles:create','roles:edit','roles:delete'],
  partners:                ['partners:view','partners:create','partners:edit','partners:delete'],
  partners_hr:             ['partners:view','partners:create','partners:edit'],
  ...
  profile:                 ['profile:view','profile:edit_self'],
  // HRM modules — must match backend Permission enum (hrm:* prefixed)
  hrm_dashboard:           ['hrm:dashboard:view'],
  ...
  hrm_hiring_hr:           ['hrm:hiring:view', 'hrm:hiring:create', 'hrm:hiring:edit'],
...
const MODULE_LABELS = {
  ...
  // HR-scoped variants (granular permission sets)
  users_hr: 'Users', partners_hr: 'Partners',
  targets_view: 'Targets (View)', reports_view: 'Reports (View)', audit_logs: 'Audit Logs',
  notifications_view: 'Notifications', profile: 'Profile',
  // HRM modules
  hrm_dashboard: 'HRM Dashboard',
  hrm_employees: 'Employees', hrm_employees_hr: 'Employees',
  hrm_attendance: 'Attendance', hrm_attendance_hr: 'Attendance',
  ...
  // Internal hiring
  hrm_requisitions: 'Job Requisitions', hrm_hiring_hr: 'Internal Hiring',
  hrm_internal_jobs: 'Internal Job Board',
