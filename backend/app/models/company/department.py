...
class DepartmentModel(BaseModel):
    ...
    code: Optional[str] = Field(None, max_length=20)          # kept for backward-compat; no longer required
    description: Optional[str] = Field(None, max_length=500)
    head_user_id: Optional[str] = None                        # Department head
    parent_department_id: Optional[str] = None                # kept for backward-compat; no longer exposed in UI
