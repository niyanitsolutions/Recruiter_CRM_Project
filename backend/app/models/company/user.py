...
ROLE_PERMISSIONS = {
    # ── Platform administration only — no recruitment/client/HR business data
    # or accounts/finance access by default (grant via per-user override) ─────
    "admin": [
        "dashboard:view",
        ...
        "hrm:performance:self", "hrm:announcements:view",
    ],
    "recruiter": [
        "dashboard:view",
